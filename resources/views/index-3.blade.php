						...
						<div class="doctor-slider slider">
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<div class="row row-sm">
										<div class="col-6">	<a href="doctor-profil" class="btn view-btn">View Profile</a>
										</div>
										<div class="col-6">	<a href="bookin" class="btn book-btn">Book Now</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
											<a href="doctor-profil">Katharine Berthold</a> 
											<i class="fas fa-check-circle verified"></i>
										</h3>
